...
namespace EyeSpy.Shared
{
    public abstract class BaseHttpService
    {
        ...
        {
            var result = await SendAndDeserialize<T>(requestType, requestUri, cancellationToken, modifyRequest, jsonRequest);
            return result;
        }
        ...
        /// <param name="modifyRequest">Modify request.</param>
        /// <param name="jsonRequest">Json request.</param>
        protected async Task<HttpResponseMessage> SendAsync(HttpMethod requestType, string requestUri, CancellationToken cancellationToken, Action<HttpRequestMessage> modifyRequest = null, string jsonRequest = null)
        {
            ...
            System.Diagnostics.Debug.WriteLine($"RESPONSE: Success={response.IsSuccessStatusCode}, Code={response.StatusCode} ({(int)response.StatusCode})");
