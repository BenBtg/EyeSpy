...
[assembly: Dependency(typeof(EyeSpyApp.Android.Services.ImagePickerService))]

namespace EyeSpyApp.Android.Services
{
    public class ImagePickerService : IImagePickerService
    {
        readonly string _defaultPictureSaveDirectory = global::Android.OS.Environment.ExternalStorageDirectory.AbsolutePath + "/Pictures/";
        ...
        public Task<Stream> TakePhoto()
        {
            ...
            intent.PutExtra(MediaStore.ExtraOutput, global::Android.Net.Uri.FromFile(_currentFile));
